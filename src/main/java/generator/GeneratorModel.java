...
import util.GenerateSetterGetter;
...
public class GeneratorModel {
    ...
    public static void generatePackage(String packages) {
        String[] directories = {"api", "controller", "model", "repository", "service", "service\\impl"};
    ...
    public static String packageImport(String root) {
        String modelPackage = root + ".model;";
        StringBuilder sb = new StringBuilder();
        sb.append("package " + modelPackage);
        sb.append("\n");
        sb.append("\n");
    ...
    public static String createModel(String root, Node nNode) {
...
//        String path = "C:\\ProjekLaporan\\" + fileName;
    ...
    public static void generateModel(Document doc) throws IOException {
        String modelPackage = getRootElement(doc) + ".model";
        List<Node> childNodes = getChildNodes(doc.getElementsByTagName("service").item(0), "entity");
        for (Node item : childNodes) {
            Element el = (Element) item;
            String data = createModel(getRootElement(doc), item);
            createJavaFile(data, className(modelPackage, el.getAttribute("name") + ".java"));
        }
    }
