                ...
                if (nNodeCol.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    if (nNodeCol.getNodeName().equals("column")) {
                        ...
                        if (eElementCol.getAttribute("primary").equalsIgnoreCase("true")) {
                            ...
                            sb.append("    @Autowired");
                            sb.append("\n");
                            sb.append("    private " + eElement.getAttribute("name") + "Service " + GeneratorModel.lop(eElement.getAttribute("name")) + "Service;");
                            sb.append("\n");
                            ...
                            sb.append("\n");
                            sb.append("        ApiResponse<List<" + eElement.getAttribute("name") + ">> apiResponse = this." + GeneratorModel.lop(eElement.getAttribute("name")) + "Service.doView();");
                            sb.append("\n");
                            ...
                            sb.append("    @PreAuthorize(\"@securityConfigService.hasPermission()\")");
                            sb.append("\n");
                            sb.append("    public ResponseEntity<ApiResponse> create(@RequestBody " + eElement.getAttribute("name") + " " + GeneratorModel.lop(eElement.getAttribute("name")) + ") {");
                            sb.append("\n");
                            sb.append("        logger.info(\"Call create function\");");
                            sb.append("\n");
                            sb.append("        ApiResponse apiResponse = this."+ GeneratorModel.lop(eElement.getAttribute("name")) + "Service.doAdd("+ GeneratorModel.lop(eElement.getAttribute("name")) + ");");
                            sb.append("\n");
                            sb.append("        return ResponseEntity.status(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON).body(apiResponse);");
                            sb.append("\n");
                            sb.append("    }");
                            ...
                            sb.append("    @PreAuthorize(\"@securityConfigService.hasPermission()\")");
                            sb.append("\n");
                            sb.append("    public ResponseEntity<ApiResponse> edit(@RequestBody " + eElement.getAttribute("name") + " " + GeneratorModel.lop(eElement.getAttribute("name")) + ") {");
                            sb.append("\n");
                            sb.append("        logger.info(\"Call edit function\");");
                            sb.append("\n");
                            sb.append("        ApiResponse apiResponse = this."+ GeneratorModel.lop(eElement.getAttribute("name")) + "Service.doEdit("+ GeneratorModel.lop(eElement.getAttribute("name")) + ");");
                            sb.append("\n");
                            sb.append("        return ResponseEntity.status(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON).body(apiResponse);");
                            sb.append("\n");
                            sb.append("    }");
                            ...
                            sb.append("    @PreAuthorize(\"@securityConfigService.hasPermission()\")");
                            sb.append("\n");
                            sb.append("    public ResponseEntity<ApiResponse> remove(@RequestBody List<" + eElement.getAttribute("name") + "> " + GeneratorModel.lop(eElement.getAttribute("name")) + "List) {");
                            sb.append("\n");
                            sb.append("        logger.info(\"Call remove function\");");
                            sb.append("\n");
                            sb.append("        ApiResponse apiResponse = this."+ GeneratorModel.lop(eElement.getAttribute("name")) + "Service.doDelete("+ GeneratorModel.lop(eElement.getAttribute("name")) + "List);");
                            sb.append("\n");
                            sb.append("        return ResponseEntity.status(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON).body(apiResponse);");
                            sb.append("\n");
                            sb.append("    }");
                            ...
                            sb.append("    @PreAuthorize(\"@securityConfigService.hasPermission()\")");
                            sb.append("\n");
                            sb.append("    public ResponseEntity<ApiResponse> preview(@RequestBody " + eElement.getAttribute("name") + " " + GeneratorModel.lop(eElement.getAttribute("name")) + ") {");
                            sb.append("\n");
                            sb.append("        logger.info(\"Call preview function\");");
                            sb.append("\n");
                            sb.append("        ApiResponse apiResponse = this."+ GeneratorModel.lop(eElement.getAttribute("name")) + "Service.doPreview("+ GeneratorModel.lop(eElement.getAttribute("name")) + ");");
                            sb.append("\n");
                            sb.append("        return ResponseEntity.status(HttpStatus.OK).contentType(MediaType.APPLICATION_JSON).body(apiResponse);");
                            sb.append("\n");
                            sb.append("    }");
